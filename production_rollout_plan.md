...
| Decision | Choice |
|----------|--------|
| Pricing model | **Hybrid** — Student Pro + school/class licences |
| Free vs Pro split | **[`gcse-competitive-analysis-and-growth.md`](gcse-competitive-analysis-and-growth.md) §5.5** — SRS free unlimited; gate AI marks, paper sims, PDF flashcards, full analytics |
| Product name | **TBD** |
...
| **2** | Free vs Pro feature gates | **Next** — see [`free_vs_pro_plan.md`](free_vs_pro_plan.md) |
...
| — | Half/full paper sims (35/70 marks) |
