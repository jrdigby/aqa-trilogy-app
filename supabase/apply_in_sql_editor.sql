...
-- ---------------------------------------------------------------------------
-- From: supabase/migrations/20260915123000_trial_hard_paywall.sql
-- 14-day student trial + hard paywall (run full migration file if preferred)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- From: supabase/migrations/20260915130000_developer_list_student_access.sql
-- ---------------------------------------------------------------------------
-- Run that migration file in the SQL editor for Pilot Pro student list + bulk update RPCs.
